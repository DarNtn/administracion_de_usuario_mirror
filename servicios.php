...
?>
<script src="funciones/servicios/funcioneServicio.js" type="text/javascript"></script>
...
<div class="panel" style="background: #50BFE6">
    <div class="panel-heading" style="color: white">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <center><img src="assets/img/servicios.png" class="img-profile img-polaroid" width="70" height="65"></center>
            </div>
            <div class="col-md-8">
                <center><h5>Control y Registro de Servicios</h5></center>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <center><a href="#nuevo" role="button" class="btn btn-danger" data-toggle="modal">
                        <strong><i class="glyphicon glyphicon-plus"></i> </strong><strong class="hidden-xs">Ingresar Nuevo</strong><strong> Servicio</strong>
                    </a></center>
            </div>
        </div>
    </div>
...
<div class="table-responsive">
    <table id="tblServicios" class="mdl-data-table" cellspacing="0" width="100%">
        <thead>
        <th>N°</th>
        <th>Nombre</th>
        <th>Valor</th>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content"> 
            <div class="modal-body">
                ...
                <center><h4 style="color: #55d9cb;">Registros de Servicio</h4></center>
                <form id="registarServicio" method="post">
                    <input type="hidden" name="opcion" value="Guardar_servicios"/>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                                <input class="form-control" type="text" name="nombre" placeholder="Nombre del Servicio" required=""/>
                            </div><br>
                        </div>
                        <div class="col-md-6">
                            <div class="input-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <select class="form-control" name="tipo">
                                    <?php
                                    $t_tServi = $conexion->realizarConsulta("SELECT * FROM tipo_servicio;");
                                    for ($a = 0; $a < sizeof($t_tServi); $a++) {
                                        echo '<option value="' . $t_tServi[$a]['tipo_servicio_id'] . '">' . $t_tServi[$a]['nombre'] . '</option>';
                                    }
                                    ?>
                                </select>
                            </div><br>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content"> 
            <div class="modal-body">
                ...
                <form id="editarServicios" method="post">
                    <input type="hidden" name="opcion" value="Editar_servicios"/>
                    <input type="hidden" name="id" id="id" value=""/>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                                <input class="form-control" type="text" id="nombre" name="nombre" placeholder="Nombre del Servicio" required=""/>
                            </div><br>
                        </div>
                        <div class="col-md-6">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-calendar-o"></i></span>
                                <input class="form-control" type="number" id="valor" name="valor" placeholder="Valor"/>
                            </div><br>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                <select class="form-control" id="tipoI" name="tipo">
                                    <?php
                                    for ($b = 0; $b < sizeof($t_tServi); $b++) {
                                        echo '<option value="' . $t_tServi[$b]['tipo_servicio_id'] . '">' . $t_tServi[$b]['nombre'] . '</option>';
                                    }
                                    ?>
                                </select>
                            </div><br>
