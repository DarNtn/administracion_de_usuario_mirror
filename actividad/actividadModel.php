...
class Actividad extends conexion {
    ...
    public function getAllEventsActividadEdit($id_aguaje, $fecha_inicio, $fecha_fin) {
        $sentencia = "SELECT * FROM actividades where  id_estado = 1 and id_aguaje <> $id_aguaje and ((fecha_inicio BETWEEN '$fecha_inicio' AND '$fecha_fin')or(fecha_fin BETWEEN '$fecha_inicio' AND '$fecha_fin')) ;";
