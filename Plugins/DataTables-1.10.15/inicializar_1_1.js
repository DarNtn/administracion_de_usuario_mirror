...
function inicializartablereporte(tabla, column, ordenColumn) {
    return $(tabla).DataTable({
        columnDefs: column,
        "order": [[ordenColumn, 'asc']],
        lengthChange: false,
        ...
        buttons: [
            {
                ...
                exportOptions: {columns: "thead th:not(.noExport)"}},
            {
                className: 'btn btn-primary btn-sm btnPdf',
                text: '<i class="fa  fa-file-pdf-o"></i>'},
            {
                className: 'btn btn-warning btn-sm btnPdfPrint',
                text: '<i class="fa fa-print"></i>'
            }]
    });
...
function inicializartableselect(tabla, column, ordenColumn,button) {
    return $(tabla).DataTable({
        paging: true,
        "pageLength": 20,
        columnDefs: column,
...
function inicializartablereporte2(tabla, column, ordenColumn,btnPdf,btnPrint, btnBar) {
    return $(tabla).DataTable({
        columnDefs: column,
        "order": [[ordenColumn, 'asc']],
        lengthChange: false,
        ...
        buttons: [
                ...
                exportOptions: {columns: "thead th:not(.noExport)"}},
            {
                ...
                text: '<i class="fa  fa-file-pdf-o"></i>'},
            {
                className: 'btn btn-warning btn-sm  ' + btnPrint,
                text: '<i class="fa fa-print"></i>'
            },
            {
                className: 'btn btn-primary btn-sm '+ btnBar,
