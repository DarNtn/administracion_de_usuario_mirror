...
INSERT  IGNORE INTO `instituciones` (`institucion_id`, `nombre`) VALUES (1,'Escoja Institución'),(2,'IEES'),(3,'Banco Pacifico'),(4,'Seguros Sucre'),(5,'Junta de Beneficencia');
...
INSERT  IGNORE INTO `grupo_sanguineo` (`idgrupo_sanguineo`, `nombre`) VALUES (1,'Escoja Grupo Sanguineo'),(2,'O+'),(3,'O-'),(4,'B+'),(5,'B-'),(6,'A+'),(7,'A-'),(8,'AB+'),(9,'AB-');
/*!40000 ALTER TABLE `grupo_sanguineo` ENABLE KEYS */;
UNLOCK TABLES;

LOCK TABLES `parentezco` WRITE;
/*!40000 ALTER TABLE `parentezco` DISABLE KEYS */;
